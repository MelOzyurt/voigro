    ...
    <div className="min-h-screen bg-background">
      ...
      <motion.section initial="hidden" animate="visible" variants={stagger} className="container py-24 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.p variants={fadeUp} className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Callio answers your business calls 24/7 with an AI agent that books appointments, captures leads, and handles orders — so you can focus on what you do best. your business calls 24/7 with an AI agent that books appointments, captures leads, and handles orders — so you can focus on what you do best.
          </motion.p>
      ...
      <section className="border-t bg-card py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground"><p className="mt-3 text-muted-foreground">From restaurants to clinics, Callio adapts to your industry.</p> className="mt-3 text-muted-foreground">From restaurants to clinics, Callio adapts to your industry.</p> to your industry.</p>
          </div>
          <div className="mx-auto mt-16 grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {useCases.map((uc, i) => (
      ...
      <section className="border-t bg-navy py-24">
        <div className="container text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-navy-foreground/70"><p className="mx-auto mt-4 max-w-xl text-navy-foreground/70">Join hundreds of businesses using Callio to handle calls, capture leads, and book appointments automatically.</p> className="mx-auto mt-4 max-w-xl text-navy-foreground/70">Join hundreds of businesses using Callio to handle calls, capture leads, and book appointments automatically.</p> calls, capture leads, and book appointments automatically.</p>
